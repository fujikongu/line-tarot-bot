...
<html>
  ...
  <body style=\"font-family: Arial, sans-serif; text-align: center; padding-top: 50px;\">
    <h1 style=\"font-size: 36px; color: #333;\">パスワード発行</h1>
    <form method=\"post\">
      <button type=\"submit\" style=\"font-size: 24px; padding: 20px 40px; background-color: #4CAF50; color: white; border: none; border-radius: 8px; cursor: pointer;\">発行する</button>
    </form>
    {% if password %}
        <div style=\"margin-top: 30px; font-size: 28px; color: #d9534f; font-weight: bold;\">発行されたパスワード: {{ password }}</div>
    {% endif %}
  </body>
</html>
"""
